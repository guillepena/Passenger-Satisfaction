...
```{r}
url_train <- "https://github.com/guillepena/Passenger-Satisfaction/blob/master/train.csv"
train_data <- read.csv("train.csv")
url_test <- "https://github.com/guillepena/Passenger-Satisfaction/blob/master/test.csv"
